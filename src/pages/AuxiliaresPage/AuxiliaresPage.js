...
import { FaUserCircle, FaCheckCircle, FaEye } from "react-icons/fa";
    ...
    <>
      ...
      <main className="content">
        <Container fluid className="mt-4">
          ...
          <p className="page-subtitle mb-4">Administra usuarios y verificaciones</p>
                ...
                <tbody>
                  {auxiliares.map((aux) => (
                    <tr key={aux.id}>
                      <td>
                        <div>
                          <strong>{aux.nombres} {aux.apellidos}</strong>
                          <div className="email">{aux.email}</div>
                        </div>
                      </td>
                      <td>
                        <span className={`role-badge ${aux.Rol === "Admin" ? "admin" : "cliente"}`}>
                          {aux.Rol || "Cliente"}
                        </span>
                      </td>
                      <td>
                      ...
                      <td>
                        <span className={`kyc-badge ${aux.estado === "Activo" ? "verificado" : "pendiente"}`}>
